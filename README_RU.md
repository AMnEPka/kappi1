...
│   │   │   ├── AdminPage.jsx          # Управление администратором
│   │   │   ├── CategoriesPage.jsx     # Категории и системы
│   │   │   ├── SystemsPage.jsx        # Управление системами
│   │   │   ├── ProjectsPage.jsx       # Список проектов
│   │   │   ├── ProjectWizard.jsx      # Мастер создания проекта
│   │   │   ├── ProjectExecutionPage.jsx # Выполнение проекта
│   │   │   └── ProjectResultsPage.jsx   # Результаты проекта
│   │   └── components/ui/    # UI компоненты (Shadcn)
│   ├── package.json
│   └── .env                   # Переменные окружения frontend
├── docker-compose.yml         # Docker Compose конфигурация
├── DOCKER_DEPLOYMENT.md       # Инструкция по развертыванию
├── DOCKER_TROUBLESHOOTING.md  # Решение проблем с Docker
└── OFFLINE_SETUP.md          # Оффлайн установка
```
...
- Поддержка base64 кодирования для корректной передачи данных
