...
JWT_ALGORITHM = "HS256"
# Access token lifetime (default: 1440 min = 24 hours).
# Override via JWT_ACCESS_TOKEN_EXPIRE_MINUTES env variable.
# Long-lived by design: browser JS timers are unreliable during idle/sleep,
# so a 24h token avoids the need for proactive refresh during a workday.
...
PERMISSIONS = {
    ...
    'config_integrity_view': 'Просмотр проверки неизменности конфигурации',
    'config_integrity_manage': 'Управление проверкой неизменности конфигурации',
}
...
PERMISSION_GROUPS = {
    ...
    'Неизменность конфигурации': [
        'config_integrity_view',
        'config_integrity_manage'
    ],
}
