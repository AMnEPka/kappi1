...
from .api_config_integrity import router as config_integrity_router
...
api_router.include_router(offline_router, tags=["offline"])
api_router.include_router(config_integrity_router)
